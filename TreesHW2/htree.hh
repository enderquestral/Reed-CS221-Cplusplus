...
class HTree {
  //does not include any private data member or methods that you'll need, so feel free to add code but do not remove anything.
 public:
  ...
  bool isValueThere(int key) const;
  void printOutList(int key)const;
